...
| **Q02** | 20/08/2026 | IEEE Xplore | `("PhoBERT") AND ("scam" OR "fraud" OR "spam") AND ("sms" OR "message" OR "text classification")` | Custom range: 2020–2026 | 1 | Top relevant | `01_all_records.csv` | Focus on applying PhoBERT for Vietnamese scam/spam message classification |
